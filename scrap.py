...
base_url = "https://www.flipkart.com/mobiles/pr?sid=tyy%2C4io"
...
for phone_card in phone_cards:
    try:
        ...
        phone_price = phone_card.find("div", class_="_30jeq3").text if phone_card.find("div", class_="_30jeq3") else "N/A"
        phone_rating = phone_card.find("div", class_="_3LWZlK").text if phone_card.find("div", class_="_3LWZlK") else "N/A"
